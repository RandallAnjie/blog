...
[链接1](https://git.zhuanjie.ltd/randall/bigc-map/releases)
...
def draw(value):
    ...
    turtle.title("导航路线")
    # 图片URL
    url = 'https://startpage.zhuanjie.ltd/json/bigc.png'
...
def init():
    # 特殊连线点
    parame = get_record('https://startpage.zhuanjie.ltd/json/parame.json')
    # 各个点在地图上的坐标
    pointin = get_record('https://startpage.zhuanjie.ltd/json/point.json')
    # 复选框的值
    valuesin = get_record('https://startpage.zhuanjie.ltd/json/values.json')
